...
4. Keep `zero-company/` as the Vite application root and keep the GitHub
...
- **Repository root** is the npm project root. It contains `.git`, repository
  ...
  `zero-company/documentation/`. Run Git,
  dependency, build, test, and run commands there.
- **Application root** is `zero-company/`. It contains the Vite entry page,
